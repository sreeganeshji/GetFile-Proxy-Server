...
"  -t [thread_count]   Num worker threads (Default is 11, Range is 1-1219)\n"               \
...
int main(int argc, char **argv) {
  ...
  printf("web proxy main \n");    
  int i;
  int option_char = 0;
  unsigned short port = 19121;
  unsigned short nworkerthreads = 11;
  ...
  while ((option_char = getopt_long(argc, argv, "xhs:t:lp:", gLongOptions, NULL)) != -1) {
    switch (option_char) {
      default:
